defmodule Admin.InternalSpecialists.Create do
  ...
  defp parse_type_from_proto(type) when is_atom(type), do: type
  defp parse_type_from_proto(type), do: Proto.AdminPanel.InternalSpecialistAccount.Type.key(type)
end
