defmodule Web.AdminApi.ExternalSpecialists.MedicalCategoriesControllerTest do
  ...
  describe "GET show" do
    ...
    test "returns medical categories for current doctor", %{conn: conn} do
      ...
      conn =
        get(conn, admin_external_specialists_medical_categories_path(conn, :show, specialist.id))
