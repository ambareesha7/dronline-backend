defmodule Web.AdminApi.InternalSpecialists.CredentialsControllerTest do
  ...
  describe "GET show" do
    ...
    test "success when payment info doesn't exist", %{conn: conn} do
      ...
      conn = get(conn, admin_internal_specialists_credentials_path(conn, :show, specialist.id))
